...
option_list <- list(
  ...
  make_option("--mapping_file", default=NULL, help="Output path and name for cis trans mapping and annotation from Locus Breaker"),
...
mapping <- read.delim(mapping_file_path)
